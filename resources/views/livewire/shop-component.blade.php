          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                ...
                <li class="mb-1"><a href="{{route('product.category',['category_slug'=>$category->slug])}}" class="d-flex"><span href="">{{$category->name}}</span> <span class="text-black ml-auto"></span></a></li>
                @endforeach
              </ul>
            </div>
