                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6 h6 mt-3">
                                Write a review, tell us about your experience.
                            </div>
                        </div>
                    </div>
                                    ...
                                    <ol class="commentlist">
                                        <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                            <div id="comment-20" class="comment_container"> 
                                                <img alt="" src="{{asset('images')}}/{{$orderItem->product->image}}" height="80" width="80">
                                                <div class="comment-text">
                                                    <p class="meta"> 
                                                        <strong class="woocommerce-review__author h4">{{$orderItem->product->name}}</strong> 
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
                                    ...
                                    <div id="respond" class="comment-respond"> 
                                        <form wire:submit.prevent="addReview" id="commentform" class="comment-form" novalidate="">
                                            <div class="comment-form-rating">
                                                <span class="h6 mt-3">Your rating</span>
                                                <p class="stars mt-2">
                                            ...
                                            <p class="comment-form-comment">
                                                <label for="comment" class="mt-3">Your review <span class="required">*</span>
                                                </label>
                                                <textarea id="comment" name="comment" cols="45" rows="8" wire:model="comment"></textarea>
                                                @error('comment') <span class="text-danger">{{$message}}</span> @enderror
                                            </p>
                                            <p class="form-submit">
                                              <input name="submit" type="submit" id="submit" class="submit btn btn-primary" value="Submit">
                                            </p>
                                        </form>
